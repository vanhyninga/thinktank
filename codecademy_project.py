...
f = Pet('Fel Spawn', 150, 50, 'Fire')
g = Pet('Tonka Tank', 220, 35, 'Electric')
...
while choice != 'Lil Ragnaros' and choice != 'Water Elemental':
  choice = input('Your choice is not available, please choose either "Lil Ragnaros" or "Water Elemental". ')
